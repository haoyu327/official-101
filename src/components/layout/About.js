          ...
          <div className="container">
            <div className="tab-container">
              ...
              <div className="tab-content" style={tag}>
                {/* <!-- 公司介紹 --> */}
                <div role="tabpanel" className="tab-pane active" id="companyintro">
                  <h3>背景</h3>
                ...
                <div role="tabpanel" className="tab-pane" id="broker">
                  ...
                  <div className="tab-content">
                    <div role="tabpanel" className="tab-pane active" id="seychel">
                      <p style={top}>
                        監管單位：塞席爾金融服務管理局 (FSA) <br />
                        牌照種類：CSL(Company special License)<br />
                        牌照編號：#SR334<br />
                        券商査詢服務：FINRA 的券商校驗
                      </p>
                    </div>
                    <div role="tabpanel" className="tab-pane" id="england">123</div>
